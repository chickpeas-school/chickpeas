...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { age_group: @year.age_group, parent_id: @year.parent_id } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { age_group: @year.age_group, parent_id: @year.parent_id } }
