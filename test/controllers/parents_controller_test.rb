...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { email: @parent.email, first_name: @parent.first_name, last_name: @parent.last_name, years: @parent.years } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { email: @parent.email, first_name: @parent.first_name, last_name: @parent.last_name, years: @parent.years } }
